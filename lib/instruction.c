...
instruction instructions[0x100] = {
    ...
    [0x22] = {IN_LD     , AM_HLI_R  , RT_HL     , RT_A                          },  // LD (HL+), A
    ...
    [0x2A] = {IN_LD     , AM_R_HLI  , RT_A                                      },  // LD A, (HL+)
    ...
    [0x32] = {IN_LD     , AM_HLD_R  , RT_HL     , RT_A                          },  // LD (HL-), A
    ...
    [0x3A] = {IN_LD     , AM_R_HLD  , RT_A                                      },  // LD A, (HL-)
    ...
    [0xA3] = {IN_AND    , AM_R      , RT_E                                      },  // AND E
    [0xA4] = {IN_AND    , AM_R      , RT_H                                      },  // AND H
    [0xA5] = {IN_AND    , AM_R      , RT_L                                      },  // AND L
    [0xA6] = {IN_AND    , AM_MR     , RT_HL                                     },  // AND (HL)
